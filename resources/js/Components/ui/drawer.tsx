...
function DrawerContent({ className, children, side = "right", ...props }: React.ComponentProps<typeof DrawerPrimitive.Content> & { side?: "top" | "right" | "bottom" | "left" }) {
	return (
...
export { Drawer, DrawerClose, DrawerContent, DrawerDescription, DrawerFooter, DrawerHeader, DrawerNestedContent, DrawerNestedRoot, DrawerOverlay, DrawerPortal, DrawerTitle, DrawerTrigger };
