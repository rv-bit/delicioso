...
export default function NavLink({ active = false, className = "", children, ...props }: InertiaLinkProps & { active: boolean }) {
	return (
		<Link
			{...props}
			className={
				"inline-flex items-center border-b-2 px-1 py-1 text-sm leading-5 font-medium transition duration-150 ease-in-out focus:outline-hidden " +
				(active
					? "border-rajah-400 focus:border-rajah-700 dark:border-rajah-600 text-gray-900 dark:text-gray-100"
