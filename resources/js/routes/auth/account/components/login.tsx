...
function LoginComponent({
	...
	return (
		<div className="from-rajah-300/20 to-rajah-400/50 flex min-h-[38.7rem] w-2xl flex-col items-center gap-10 overflow-hidden bg-gradient-to-br px-24 py-12 shadow-xl max-lg:w-full max-lg:px-10 max-lg:py-8 max-sm:scale-95">
			...
			<form onSubmit={submit} className="flex w-full flex-col justify-center gap-2">
				<div className="flex h-auto w-full flex-col items-start justify-start gap-1">
					<InputFocus id="email" type="email" name="Email" value={data.email} onChange={(e) => setData("email", e.target.value)} className="rounded-none px-3 py-7.5 pb-5" />
