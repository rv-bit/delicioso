			...
			<div className="relative h-full min-h-[31.2rem] w-full overflow-hidden rounded-xs">
				<picture>
					...
					<img
						...
						srcSet="/media/landing/banner/banner-2000.webp 2000w, /media/landing/banner/banner-1024.webp 1024w, /media/landing/banner/banner-768.webp 768w, /media/landing/banner/banner-640.webp 640w"
						// loading="lazy"
						alt="Cake Banner"
						onLoad={() => {
